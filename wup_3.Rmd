...
A multiple comparison test showcase a substantial difference or a lack of using each pair of data. The comparison of the middle row and the front had little to no difference to each other. This is shown by the 0 borken line, this bracket is placed where this broke line is and explains there is no difference in the data. The middle and back seats are on the right portion of the graph and show a negative result, based on the bottom line, placing it at the approximately -11. The front and back portions were compared and showed the most significant change in numerical data. The bracket is in the negative numbers, at around -13. This inference explains the most drinking was done by the back row. 
